...
const Card = (props) => {
    return (
        ...
        <div className="w-[235px] h-[130px] rounded-[20px] border-[3px] border-[#2899CB] ml-[37px] mt-[50px] pt-[25px] bg-blue-600 justify-items-center  hover:scale-110 hover:bg-[#2899CB] hover:border-[#0A2463]" onClick={props.onclick}>
