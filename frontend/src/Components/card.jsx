...
const Card = (props) => {
    return (
        <div className=" w-full">
          <div className="w-[235px] h-[130px] rounded-[20px] border-[2px] border-[#FFCB05] ml-[37px] mt-[50px] pt-[25px] bg-gradient-to-r from-[#272C48] to-[#2899CB] justify-items-center  shadow-2xl hover:scale-110">
