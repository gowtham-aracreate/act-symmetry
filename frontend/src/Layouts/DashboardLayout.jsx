     ...
     return (
          <div className='md:h-screen bg-gray-100 flex'>
               ...
               <aside className="w-[296px] bg-white flex flex-col gap-4 h-screen pt-[80px] pl-[10px]">
                    ...
                    <div 
                         className="flex items-center w-[170px] absolute bottom-2 ml-[19px] hover:bg-black text-black hover:text-white rounded-xl cursor-pointer transition-transform transform hover:scale-105" 
                         onClick={() => navigate('/')}
